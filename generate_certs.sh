...
ORGANIZATION="MyCompany"            # O  - 조직명
ORG_UNIT="DataEngineering"          # OU - 부서명

# 도메인 정보
DOMAIN="example.com"                # 호스트명에 붙는 기본 도메인

# CA 설정
CA_CN="MyCompany Internal CA"       # CA의 Common Name
...
echo ""
echo " 3. Cloudera Manager 환경:"
echo "    - JKS 변환: openssl pkcs12 → keytool importkeystore"
echo "    - CA를 JDK truststore(jssecacerts)에 등록"
echo "============================================================"
